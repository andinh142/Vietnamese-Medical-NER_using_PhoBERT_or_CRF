...
import pickle  # Dùng 'pickle' là đúng
import re      # <-- THÊM MỚI: Cần cho 'extract_features'

# Import class PhoBERT của bạn
from inference import ViMedNERInference
...
CRF_PREPROCESSOR_PATH = "models/best_model/crf_preprocessor.pkl"
CRF_MODEL_PATH = "models/best_model/crf_model.pkl"
